    ...
    return (
      <main className="w-full flex flex-col gap-12 flex-grow font-rale justify-evenly bg-mountain2 bg-cover">
        <div className="w-5/6 flex flex-col mt-3 mx-auto justify-evenly p-1 gap-2"> 
          ...
          <Anchor to={'/cities'}>
            <button className="w-2/5 justify-center rounded-[8px] hover:bg-[#00000099] text-white text-sm  font-semibold
            bg-[#00000049] lg:w-1/5">View More</button>
          </Anchor>
        </div>
        <div className="w-full p-3"><Carousel data={carousel} /></div>
    </main>
  )
}
